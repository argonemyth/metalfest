define(['jquery', 'knockout', 'underscore', 'humane', 'foundation', 'slider', 'select2', 'validation', 'jscrollpane'], function($, ko, _, humane) {
    ...
    function FestivalMapViewModel() {
        ...
        // self.min_date = ko.observable(date_range.minDate);
        // self.max_date = ko.observable(date_range.maxDate);
        self.bound_min_date = ko.observable(date_range.minDate);
        self.bound_max_date = ko.observable(date_range.maxDate);
        self.date_range = ko.computed(function() {
            return self.min_date() + " - " + self.max_date();
        }, self);
        self.date_range_bound = ko.computed(function() {
            return self.bound_min_date() + " - " + self.bound_max_date();
        }, self);
        ...
        self.displayedFestivals.subscribe(function (festivals) {
            ...
            console.log("displayedFestival changed." + self.min_date() + '; Festivals: ' + numDisplayed);
        ...
        self.date_range.subscribe(function (date_range) { 
            console.log("date range value changed");
        ...
        self.date_range_bound.subscribe(function (date_range) { 
            // Change date range bounds 
            console.log("date bound has changed");
        ...
        $.getJSON("/metalmap/all/?start_date=" + date_range.minDateStr + "&end_date=" + date_range.maxDateStr, function(data) {
            ...
            console.log(self.festivals().length + " festivals loaded")
            $("#loader").hide();
        });
    ...
    ko.bindingHandlers.daterange = {
        init: function(element, valueAccessor, allBindings, viewModel, bindingContext) {
            ...
            $(element).dateRangeSlider({
                ...
                console.log("datarange value changed: " + data);
