...
from metalmap.utils import query_musicbrainz
...
class Event(models.Model):
    """ Abstract model for Gig and Festival. """
    ...
    # Time & Location
    start_date = models.DateField(_("start_date"), db_index=True,
                                  null=True, blank=True)
    ...
    # Lineup info
    artists = models.ManyToManyField('metalmap.Artist', null=True, blank=True,
                                     related_name="%(class)ss")
...
class Festival(Event):
    ...
    url = models.URLField(_("festival official URL"), blank=True, null=True)
