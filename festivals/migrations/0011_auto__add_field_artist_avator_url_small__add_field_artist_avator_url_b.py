...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.avator_url_small'
        db.add_column(u'festivals_artist', 'avator_url_small',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.avator_url_big'
        db.add_column(u'festivals_artist', 'avator_url_big',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.avator_url_small'
        db.delete_column(u'festivals_artist', 'avator_url_small')

        # Deleting field 'Artist.avator_url_big'
        db.delete_column(u'festivals_artist', 'avator_url_big')
    ...
    models = {
        ...
        u'festivals.artist': {
            ...
            'avator_url_big': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'avator_url_small': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
