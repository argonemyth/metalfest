...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.twitter_url'
        db.add_column(u'festivals_artist', 'twitter_url',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Artist.twitter_url'
        db.delete_column(u'festivals_artist', 'twitter_url')
