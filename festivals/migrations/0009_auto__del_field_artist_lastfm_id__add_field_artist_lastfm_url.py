...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Artist.lastfm_id'
        db.delete_column(u'festivals_artist', 'lastfm_id')

        # Adding field 'Artist.lastfm_url'
        db.add_column(u'festivals_artist', 'lastfm_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Artist.lastfm_id'
        db.add_column(u'festivals_artist', 'lastfm_id',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Artist.lastfm_url'
        db.delete_column(u'festivals_artist', 'lastfm_url')
