...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Festival.computed_address'
        db.add_column(u'festivals_festival', 'computed_address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Festival.computed_address'
        db.delete_column(u'festivals_festival', 'computed_address')
