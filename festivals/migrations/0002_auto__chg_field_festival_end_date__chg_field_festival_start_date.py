...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'festivals_festival', 'end_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Festival.start_date'
        db.alter_column(u'festivals_festival', 'start_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Festival.end_date'
        db.alter_column(u'festivals_festival', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Festival.start_date'
        db.alter_column(u'festivals_festival', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
