...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Festival.end_date'
        db.alter_column(u'festivals_festival', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Festival.start_date'
        db.alter_column(u'festivals_festival', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Festival.end_date'
        db.alter_column(u'festivals_festival', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 20, 0, 0)))

        # Changing field 'Festival.start_date'
        db.alter_column(u'festivals_festival', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 20, 0, 0)))
