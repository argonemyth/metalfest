...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Festival.lastfm_url'
        db.add_column(u'festivals_festival', 'lastfm_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.lastfm_id'
        db.add_column(u'festivals_festival', 'lastfm_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Festival.lastfm_url'
        db.delete_column(u'festivals_festival', 'lastfm_url')

        # Deleting field 'Festival.lastfm_id'
        db.delete_column(u'festivals_festival', 'lastfm_id')
