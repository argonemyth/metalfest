...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Festival.location'
        db.alter_column(u'festivals_festival', 'location', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Festival.location'
        db.alter_column(u'festivals_festival', 'location', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=300))
