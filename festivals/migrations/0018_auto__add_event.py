...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Event'
        db.create_table(u'festivals_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('lastfm_id', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True)),
        ...
        db.send_create_signal(u'festivals', ['Event'])

        # Adding M2M table for field artists on 'Event'
        m2m_table_name = db.shorten_name(u'festivals_event_artists')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'festivals.event'], null=False)),
            ('artist', models.ForeignKey(orm[u'festivals.artist'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'festivals_event')

        # Removing M2M table for field artists on 'Event'
        db.delete_table(db.shorten_name(u'festivals_event_artists'))
    ...
    models = {
        ...
        u'festivals.event': {
            'Meta': {'ordering': "('-date', 'name')", 'object_name': 'Event'},
