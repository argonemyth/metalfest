...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.official_url'
        db.add_column(u'festivals_artist', 'official_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.ma_url'
        db.add_column(u'festivals_artist', 'ma_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.fb_url'
        db.add_column(u'festivals_artist', 'fb_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.twitter_name'
        db.add_column(u'festivals_artist', 'twitter_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.mbid'
        db.add_column(u'festivals_artist', 'mbid',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.country'
        db.add_column(u'festivals_artist', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities_light.Country'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.official_url'
        db.delete_column(u'festivals_artist', 'official_url')

        # Deleting field 'Artist.ma_url'
        db.delete_column(u'festivals_artist', 'ma_url')

        # Deleting field 'Artist.fb_url'
        db.delete_column(u'festivals_artist', 'fb_url')

        # Deleting field 'Artist.twitter_name'
        db.delete_column(u'festivals_artist', 'twitter_name')

        # Deleting field 'Artist.mbid'
        db.delete_column(u'festivals_artist', 'mbid')

        # Deleting field 'Artist.country'
        db.delete_column(u'festivals_artist', 'country_id')
    ...
    models = {
        ...
        u'festivals.festival': {
            ...
            'artists': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['festivals.Artist']", 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastfm_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
